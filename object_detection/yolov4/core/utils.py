...
package_dir = Path(os.path.realpath(__file__)).parent.parent
...
def read_class_names(class_file_name):
    ...
    names = {}
    class_file_name = os.path.join(Path(os.path.realpath(__file__)).parent.parent,class_file_name)
...
def get_anchors(anchors_path, tiny=False):
    ...
    anchors_path = os.path.join(package_dir,anchors_path)
